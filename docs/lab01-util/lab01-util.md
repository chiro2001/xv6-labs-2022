...
```sh
➜ chiro@chiro-pc  ~/os/xv6-labs-2022 git:(util) ✗ ./grade-lab-util 
make: “kernel/kernel”已是最新。== Test sleep, no arguments == sleep, no arguments: OK (1.5s) 
